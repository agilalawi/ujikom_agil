    ...
    <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../galeri/uploads/rpl.jpeg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../galeri/uploads/sabat.jpeg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../galeri/uploads/bdp.jpeg" class="d-block w-100" alt="...">
          </div>
        </div>
